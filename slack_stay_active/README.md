...
config:
  ...
  webbrowser:
    ...
    window_size: 300,500
    # Either get the "latest" and greatest that we can download; or get the "installed" Chrome web browser version; or set a specific version like: "102.0.5005.61"
    chrome_version: "installed"
  times:
...
```
/> conda install -c conda-forge selenium webdriver-manager cerberus pyyaml
```
